...
4. чете координати на правоъгълник (`(x,y,width,height)` - координатите на горния ляв ъгъл, дължината и височината на правоъгълника) и:
    1. N на брой точки `(x,y)` и отпечатва колко от тях лежат в правоъгълника;
    2. N на брой кръга, всеки от тях зададен с координати на центъра `(x, y)` и дължина на радиуса, и отпечатва колко от тях имат сечение с правоъгълника.
